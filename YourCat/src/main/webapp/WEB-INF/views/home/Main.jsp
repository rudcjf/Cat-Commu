...
<script>
function initMap() {
var myCenter = new google.maps.LatLng(37.5013068, 127.03965970000002);
...
<script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAarEHrOklqP1X_ajwoCTRygDSmytDJ54k&callback=initMap">
    </script>
<!--
